...
;FRINGE is a list of tree leaf nodes
;BFS returns a list of those nodes in increasing depth
;this means the most shallow of nodes appears first
(defun BFS (FRINGE)
  (cond ((null FRINGE) ())
